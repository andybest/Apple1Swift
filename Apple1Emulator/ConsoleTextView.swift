...
class ConsoleTextView: NSView {
    ...
    func setup() {
        ...
        self.cursorBlinkTimer = Timer.scheduledTimer(timeInterval: 0.5, target: self, selector: #selector(ConsoleTextView.cursorTimerFired), userInfo: nil, repeats: true)
    }
